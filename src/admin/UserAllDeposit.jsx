...
export default function UserAllDeposit() {
    ...
    const [URL, setURL] = useState(`${API_URL}/api/v1/admin/get-user-all-deposit?id=${userId}&filter=${filter}&page=${currentPage}&limit=10`);
    ...
    useEffect(() => {
        ...
        setURL(`${API_URL}/api/v1/admin/get-user-all-deposit?id=${userIdQuery}&filter=${filter}&page=${pageFromQuery}&limit=10`);
    }, [location, filter]);
