...
export default function AllWithdrawal() {
    ...
    const [URL, setURL] = useState(`${API_URL}/api/v1/admin/view-withdrawal?filter=${filter}&page=${currentPage}&limit=10`);
    ...
    useEffect(() => {
        ...
        setURL(`${API_URL}/api/v1/admin/view-withdrawal?filter=${filter}&page=${pageFromQuery}&limit=10`);
    }, [location, filter]);
